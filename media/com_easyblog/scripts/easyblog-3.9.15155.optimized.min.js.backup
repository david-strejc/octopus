...
(function(){var c=q.stylesheet({content:""})?"resolve":"reject";q.each(["easyblog/fancybox/default"],function(h,a){q.require.stylesheet.loader(a)[c]()})})()});
FD31.installer("EasyBlog","scripts",function(q){EasyBlog.module("admin",function(c){var h=window.admin={blog:{reject:function(a){ejax.load("Pending","confirmRejectBlog",a)},approve:function(a,b){confirm(b)&&(window.location=eblog_site+"&c=pending&task=approve&cid[]="+a)}},settings:{importSettings:function(){ejax.load("settings","import")}},checkbox:{init:function(){c(".option-enable").click(function(){var a=c(this).parent();c(".option-disable",a).removeClass("selected");c(this).addClass("selected");
c(".radiobox",a).attr("value",1)});c(".option-disable").click(function(){var a=c(this).parent();c(".option-enable",a).removeClass("selected");c(this).addClass("selected");c(".radiobox",a).attr("value",0)})}},pending:{reject:function(){}},spools:{preview:function(a){ejax.load("Spools","preview",a)}},teamblog:{markAdmin:function(a,b,c){window.location=eblog_site+"&c=teamblogs&task=markAdmin&teamid="+a+"&userid="+b+"&"+c+"=1"},removeAdmin:function(a,b){window.location=eblog_site+"&c=teamblogs&task=removeAdmin&teamid="+
a+"&userid="+b+"&"+token+"=1"}}};c(function(){var a=c("#submenu").attr("class");0<c("#submenu li").eq(4).length&&"settings"!=a&&ejax.load("Easyblog","appendPending");0<c("#system-message").length&&0==c(".eb-bootstrap").length&&(a=c("#system-message").html(),c("#system-message").remove(),c('<dl id="system-message">'+a+"</dl>").insertAfter("#toolbar-box"));c("body #settingsForm .admintable tr:odd").addClass("tr-odd");c(".admintable tr").hover(function(){c(this).addClass("tr-hover")},function(){c(this).removeClass("tr-hover")});
...
socialshare:{setActive:function(a){c(a).parent().toggleClass("active")}},drafts:{discard:function(b){a.load("dashboard","confirmDeleteDraft",b)},discardAll:function(){a.load("dashboard","confirmDeleteAllDraft")}},lists:{init:function(a){c("#dashboard-"+a).checkList({checkbox:".stackSelect",masterCheckbox:".stackSelectAll",change:function(a,b){this.parent(".ui-list-select").toggleClass("active",0<a.length);c("#select-actions").toggle(0<a.length)}})}},toggle:function(a){"block"==c(a).parent().next().css("display")?
(c(a).parent().addClass("ui-togbox"),c(a).parent().next().hide()):(c(a).parent().removeClass("ui-togbox"),c(a).parent().next().show())},quickpost:{notify:function(a,e){c("#eblog-message").removeClass("error info success").addClass(a);c("#eblog-message div").html(e);c("#eblog-message").show()},save:function(){h.loader.loading("quickpost-loading");var b=a.getFormVal("#quick-post");a.load("dashboard","save",b)},draft:function(){h.loader.loading("quickdraft-loading");var b=c("#eblog-post-content").val();
a.load("dashboard","quickSaveDraft",a.getFormVal("#quick-post"),b,"")}},settings:{submit:function(){if((""!=c("#password").val()||""!=c("#password2").val())&&c("#password").val()!=c("#password2").val())return c(".password-notice").show(),!1;c("#dashboard").submit()}},categories:{create:function(){"block"==c("#widget-create-category").css("display")?c("#widget-create-category").slideUp():c("#widget-create-category").slideDown();return!1},edit:function(b){a.load("dashboard","editCategory",b)},remove:function(b,
c){a.load("dashboard","confirmDeleteCategory",c,b)},quicksave:function(b){a.load("dashboard","quickSaveCategory",b)}},comments:{publish:function(b,c){a.load("dashboard","publishComment",b,c)},publishModerated:function(b,c){a.load("dashboard","publishModerateComment",b,c)},edit:function(b){a.load("dashboard","editComment",b)},remove:function(b,c){a.load("dashboard","confirmDeleteComment",c,b)}},action:function(b,e){var f=c("#"+b+"-action").val(),g="";c("#"+b+'-form INPUT[name="cid[]"]').each(function(){c(this).prop("checked")&&
(g=0==g.length?c(this).val():g+","+c(this).val())});if(""==g)h.system.alert("COM_EASYBLOG_PLEASE_SELECT_ONE_ITEM_TO_CONTINUE","COM_EASYBLOG_WARNING");else switch(f){case "copy":a.load("dashboard","copyForm",g);break;case "discardDraft":h.dashboard.drafts.discard(g);break;case "publishBlog":h.blog.togglePublish(g,"publish");break;case "unpublishBlog":h.blog.togglePublish(g,"unpublish");break;case "deleteBlog":h.blog.confirmDelete(g,e);break;case "rejectBlog":h.editor.reject(g);break;case "unpublishComment":h.dashboard.comments.publish(g,
"unpublish");break;case "publishComment":h.dashboard.comments.publish(g,"publish");break;case "removeComment":h.dashboard.comments.remove(e,g,"");break;default:h.system.alert("COM_EASYBLOG_PLEASE_SELECT_ACTION_TO_PERFORM","COM_EASYBLOG_WARNING")}},videos:{insert:function(b){var e=c("#video-source").val(),f=c("#video-width").val(),g=c("#video-height").val();jInsertEditorText('[embed=videolink]{"video":"'+e+'","width":"'+f+'","height":"'+g+'"}[/embed]',b);a.closedlg()},showForm:function(b){try{IeCursorFix()}catch(c){}a.load("dashboard",
"showVideoForm",b)}},preview:function(b){var e=h.drafts.getContent();if("undefined"!=typeof e){var f=c("#eblog-wrapper #title").val();0<e.length&&0<f.length&&f!=emptyText?a.call("dashboard","saveDraft",[a.getFormVal("#blogForm"),e,""],{success:function(){var a=c("#draft_id").val();if(""!=a){var d=screen.width,l=screen.height;window.open(c.rootPath+"/index.php?option=com_easyblog&view=entry&layout=preview&draftid="+a+"&Itemid="+b,"","toolbar=no, location=no, directories=no, status=yes, menubar=yes, scrollbars=yes, resizable=yes, copyhistory=no, width="+
d+", height="+l+", top="+(screen.height/2-l/2)+", left="+(screen.width/2-d/2))}}}):0<e.length?h.system.alert("COM_EASYBLOG_PLEASE_SET_TITLE_BEFORE_PREVIEW","COM_EASYBLOG_ENTRY_PREVIEW_MODE"):h.system.alert("COM_EASYBLOG_ENTRY_PREVIEW_MODE_NO_CONTENT","COM_EASYBLOG_ENTRY_PREVIEW_MODE")}}},editor:{checkPublishStatus:function(){var b=c("#published").val(),e=c("#publish_down").val();if(""==e||"0000-00-00 00:00:00"==e)return h.editor.postSubmit(),!0;a.load("dashboard","checkPublishStatus",b,e);return!0},
cancelSubmit:function(){isSave=!1;c("#save_post").attr("disabled","");return!1},postSubmit:function(){c(window).unbind("beforeunload");c("#blogForm").submit()},save:function(){h.editor.toggleSave();var a=h.editor.getContent(),e=a.split('<hr id="system-readmore" />');1<e.length?(a=c.sanitizeHTML(e[0]),e=c.sanitizeHTML(e[1]),e=a+'<hr id="system-readmore" />'+e):e=c.sanitizeHTML(a);c("#write_content_hidden").val(e);c("#save_post_button").addClass("ui-disabled");c("#save_post_button").attr("disabled",
"disabled");h.editor.checkPublishStatus()},apply:function(){c("input[name=apply]").val(1);h.editor.save()},reject:function(b){a.load("Dashboard","confirmRejectBlog",b)},search:{load:function(){try{IeCursorFix()}catch(b){}a.load("search","search",c("#search-content").val())},insert:function(a,e,f){a='<a href="'+a+'">'+e+"</a>";switch(f){case "intro":c("#widget-write-introtext .ui-modhead").hasClass("ui-togbox")?h.editor.setIntro(a):jInsertEditorText(a,f);break;case "write_content":c("#widget-writepost .ui-modhead").hasClass("ui-togbox")?
h.editor.setContent(a):jInsertEditorText(a,f)}}},setIntro:null,setContent:null,getContent:null,datetimepicker:{element:function(a,e){c("#datetime_"+a).addClass("toggle-active");c("#datetime_edit_"+a).hide();var f,g,d,l,m,n;h.editor.datetimepicker.hideEditLink(a);h.editor.datetimepicker.hideEditLink(a);"publish_down"==a&&""==c("#"+a).val()&&(f=c("#publish_down_reset").val(),c("#"+a).val(f));""!=c("#"+a).val()?(f=c("#"+a).val().split(" "),m=f[1].split(":"),d=f[0].split("-"),f=d[2],g=d[1],d=d[0],l=m[0],
m=m[1]):(today=new Date,f=today.getDate(),g=today.getMonth()+1,d=today.getFullYear(),l=today.getHours(),m=today.getMinutes());l=parseInt(l,10);1>=m.length&&(m="0"+m);n=12<=l?"pm":"am";12<l&&(l-=12);"am"==n&&0==l&&(l=12);10>l&&(l="0"+l);var k;k=""+('<div class="dtpicker-wrap" id="dtpicker_'+a+'" style="display: none;">')+('\t<select tabindex="4" name="dt_month" id="dt_month_'+a+'">');k+='\t\t<option value="01" '+("01"==g?'selected="selected"':"")+">"+sJan+"</option>";k+='\t\t<option value="02" '+("02"==
g?'selected="selected"':"")+">"+sFeb+"</option>";k+='\t\t<option value="03" '+("03"==g?'selected="selected"':"")+">"+sMar+"</option>";k+='\t\t<option value="04" '+("04"==g?'selected="selected"':"")+">"+sApr+"</option>";k+='\t\t<option value="05" '+("05"==g?'selected="selected"':"")+">"+sMay+"</option>";k+='\t\t<option value="06" '+("06"==g?'selected="selected"':"")+">"+sJun+"</option>";k+='\t\t<option value="07" '+("07"==g?'selected="selected"':"")+">"+sJul+"</option>";k+='\t\t<option value="08" '+
("08"==g?'selected="selected"':"")+">"+sAug+"</option>";k+='\t\t<option value="09" '+("09"==g?'selected="selected"':"")+">"+sSep+"</option>";k+='\t\t<option value="10" '+("10"==g?'selected="selected"':"")+">"+sOct+"</option>";k+='\t\t<option value="11" '+("11"==g?'selected="selected"':"")+">"+sNov+"</option>";k+='\t\t<option value="12" '+("12"==g?'selected="selected"':"")+">"+sDec+"</option>";k+="\t</select>";k+='\t<input type="text" autocomplete="off" tabindex="4" maxlength="2" size="2" value="'+
f+'" name="dt_day" id="dt_day_'+a+'">, ';k+='\t<input type="text" autocomplete="off" tabindex="4" maxlength="4" size="4" value="'+d+'" name="dt_year" id="dt_year_'+a+'"> @ ';k+='\t<input type="text" autocomplete="off" tabindex="4" maxlength="2" size="2" value="'+l+'" name="dt_hour" id="dt_hour_'+a+'"> : ';k+='\t<input type="text" autocomplete="off" tabindex="4" maxlength="2" size="2" value="'+m+'" name="dt_min" id="dt_min_'+a+'">';k+='\t<select tabindex="4" name="dt_ampm" id="dt_ampm_'+a+'">';k+=
'\t\t<option value="am" '+("am"==n?'selected="selected"':"")+">"+sAm+"</option>";k+='\t\t<option value="pm" '+("pm"==n?'selected="selected"':"")+">"+sPm+"</option>";k+="\t</select>";k+='\t<div class="dtpicker-action" id="dtpicker_action_'+a+'">';k+='\t\t<a class="dtpicker-save ui-button" href="javascript:void(0);" onclick="eblog.editor.datetimepicker.save(\''+a+"')\">"+btnOK+"</a>";e&&(k+='\t\t<a class="dtpicker-reset" href="javascript:void(0);" onclick="eblog.editor.datetimepicker.reset(\''+a+"')\">"+
btnReset+"</a>");k+='\t\t<a class="dtpicker-cancel" href="javascript:void(0);" onclick="eblog.editor.datetimepicker.cancel(\''+a+"')\">"+btnCancel+"</a>";k+="\t</div>";k+="</div>";c(k).insertAfter("#datetime_"+a);c("#dtpicker_"+a).slideDown("fast")},reset:function(a){c("#dtpicker_"+a).slideUp("fast");c("#"+a).val("");c("#datetime_"+a+" .datetime_caption").html(sNever);h.editor.datetimepicker.showEditLink(a)},cancel:function(a){c("#dtpicker_"+a).slideUp("fast");"publish_down"!=a||""!=c("#publish_down_ori").val()&&
...
" #frmComment").clone();c("#eblog-wrapper #comment-reply-form-"+a+" #frmComment").remove();c("#eblog-wrapper #comment-separator").after(e);c("#parent_id").val("0");c("#comment_depth").val("0");c("#comment-reply-form-"+a).hide();c("#title.inputbox").val("");c("#toolbar-reply-"+a).toggleClass("show-this");c("#toolbar-cancel-"+a).toggleClass("show-this");c("#toolbar-cancel-"+a).parent(".comment-reply").toggleClass("in-action")},edit:function(){c("#eblog-message").removeClass("info error");c("#eblog-message").html("");
finalData=a.getFormVal("#frmComment");a.load("dashboard","updateComment",finalData)},action:function(b,e){var f=0,g="",d=c("#"+b).val();""==d?h.system.alert("COM_EASYBLOG_PLEASE_SELECT_ACTION_TO_PERFORM","COM_EASYBLOG_WARNING"):(c("#adminForm INPUT[name='cid[]']").each(function(){c(this).attr("checked")&&(g=0==g.length?c(this).val():g+","+c(this).val(),f++)}),0>=f?h.system.alert("COM_EASYBLOG_PLEASE_SELECT_ONE_ITEM_TO_CONTINUE","COM_EASYBLOG_WARNING"):"unpublishComment"==d?a.load("dashboard","publishComment",
g,"0","comment"):"publishComment"==d?a.load("dashboard","publishComment",g,"1","comment"):"removeComment"==d&&h.comment.confirm(e,g,""))},confirm:function(a,c,f){h.system.dialog("COM_EASYBLOG_ARE_YOU_SURE_YOU_WANT_TO_REMOVE_COMMENT",'window.location = "'+(a+"&task=removeComment&commentId="+c)+'";',"CONFIRMATION")},displayInlineMsg:function(a,e){c("#eblog-message").removeClass("info error");c("#eblog-message").html(e);c("#eblog-message").addClass(a);"info"==a&&setTimeout(function(){c("#eblog-message").removeClass("info error");
c("#eblog-message").html("")},6E3)}},featured:{add:function(b,c){a.load("Latest","makeFeatured",b,c)},remove:function(b,c){a.load("Latest","removeFeatured",b,c)},slider:{holderWidth:0,element:[],autorotate:function(a){var e=c("#ezblog-featured .featured-a").children(),f=!1;c(e).each(function(){c(this).hasClass("active")&&!0!=f&&(0==c(this).next().length?c("#ezblog-featured .featured-a :first").click():c(this).next().click(),f=!0)});setTimeout("eblog.featured.slider.autorotate("+a+");",a)},init:function(a,
e,f){h.featured.slider.element[a]={width:parseInt(c("."+a).parent().width()),element:"."+a};var g=0;c(h.featured.slider.element[a].element).children().each(function(){g+=h.featured.slider.element[a].width});c(h.featured.slider.element[a].element).css("width",g);c(h.featured.slider.element[a].element).children().css("width",h.featured.slider.element[a].width);e&&(f=1E3*parseInt(f),setTimeout("eblog.featured.slider.autorotate("+f+");",f))},slide:function(a,e){var f=0,g=a;1!=a&&(f=h.featured.slider.element[e].width*
parseInt(a-1));c(h.featured.slider.element[e].element).animate({left:"-"+f+"px"},"slow");c(h.featured.slider.element[e].element).parent().parent().children("div.featured-navi").children().children().removeClass("active");c(h.featured.slider.element[e].element).parent().parent().children("div.featured-navi").children().children(".slider-navi-"+g).addClass("active")}}},spinner:{show:function(){c("#blogSubmitBtn").hide();c("#blogSubmitWait").show()},hide:function(){c("#blogSubmitWait").hide();c("#blogSubmitBtn").show()},
publish:function(a,e){1==e?c("#"+a+"Spinner").html('<img src="'+spinnerPath+'" alt="Loading">'):c("#"+a+"Spinner").html("")}},element:{focus:function(b){ele="#"+b;c(ele).focus();a.closedlg()}},blog:{publish:function(a,c,f){window.location=a+"&task=toggleBlogStatus&status="+f+"&blogId="+c},remove:function(b,e){var f="",g=e?e:"Dashboard";c.each(b,function(){h.spinner.publish(b,1);""!=f&&(f+=",");f+=this});a.load("Dashboard","deleteBlog",f,g)},confirmDelete:function(b,c){a.load("dashboard","confirmDelete",
b,c)},confirm:function(a,c,f){},approve:function(b,c){a.load("dashboard","confirmApproveBlog",c,b)},ajaxpublish:function(b,e,f){var g="";f=f?f:"Dashboard";c.each(b,function(){h.spinner.publish(b,1);""!=g&&(g+=",");g+=this});a.load("Dashboard","togglePublishStatus",g,e,f)},togglePublish:function(b,c){a.load("dashboard","togglePublish",b,c)},action:function(a,e){var f=0,g="",d=c("#"+a).val();"default"!=d&&(c("#adminForm INPUT[name='cid[]']").each(function(){c(this).attr("checked")&&(g=0==g.length?c(this).val():
g+","+c(this).val(),f++)}),0>=f?h.system.alert("COM_EASYBLOG_PLEASE_SELECT_ONE_ITEM_TO_CONTINUE","COM_EASYBLOG_WARNING"):"unpublishBlog"==d?h.blog.togglePublish(g,"unpublish"):"publishBlog"==d?h.blog.togglePublish(g,"publish"):"deleteBlog"==d&&h.blog.confirmDelete(g,e))},tab:{init:function(){c(".tab_container").hide();c("div.tab-wrapper .tab_container:first").show();c(".tab_item:first").addClass("item-active");c("ul.tab_button li.tab_item a").click(function(){var a=c(this).parent();if(a.hasClass("item-active"))return!1;
a.siblings().each(function(){c(this).hasClass("item-active")&&c(this).removeClass("item-active")});a.addClass("item-active");c(".tab_container").hide();a=a.attr("id").split("-")[1];c("#section-"+a).show();return!1})}},unsubscribe:function(b,c){a.load("entry","confirmUnsubscribeBlog",b,c)}},tag:{remove:function(b,c){a.load("Dashboard","confirmDeleteTag",c,b)},edit:function(b){a.load("Dashboard","editTagDialog",b)},action:function(a,e){var f=0,g="",d=c("#"+a).val();""==d?h.system.alert("COM_EASYBLOG_PLEASE_SELECT_ACTION_TO_PERFORM",
"COM_EASYBLOG_WARNING"):(c("#adminForm INPUT[name='cid[]']").each(function(){c(this).attr("checked")&&(g=0==g.length?c(this).val():g+","+c(this).val(),f++)}),0>=f?h.system.alert("COM_EASYBLOG_PLEASE_SELECT_ONE_ITEM_TO_CONTINUE","COM_EASYBLOG_WARNING"):"deleteTag"==d&&h.tag.confirm(e,g,""))},confirm:function(a,c,f){h.system.dialog("COM_EASYBLOG_ARE_YOU_SURE_YOU_WANT_TO_REMOVE_TAGS",'window.location = "'+(a+"&task=deleteTag&tagId="+c)+'";',"CONFIRMATION")},save:function(){finalData=a.getFormVal("#frmEditTag");
a.load("Dashboard","saveTag",finalData)}},socialshare:{share:function(b,c){h.spinner.publish(b,1);a.load("dashboard","ajaxSocialShare",b,c)}},twitter:{update:function(b){""!=b&&(h.spinner.publish(b,1),a.load("Dashboard","ajaxUpdateTwitter",b))}},form:{checkbox:{checkall:function(){c("#adminForm INPUT[type='checkbox']").each(function(){c("#toggle").attr("checked")?c(this).attr("checked",!0):c(this).attr("checked",!1)});return!1}}},trackback:{url:{copy:function(){c("#trackback-url").focus().select()}}},
system:{alert:function(b,c){a.alert(a.string(b),a.string(c),"450","auto")},dialog:function(b,c,f){c='<div class="dialog-actions"><input type="button" value="'+a.string("No")+'" class="button" id="edialog-cancel" name="edialog-cancel" onclick="ejax.closedlg();" /><input type="button" value="'+a.string("Yes")+'" class="button" id="edialog-submit" name="edialog-submit" onclick="'+c+'" /></div>';b={title:a.string(f),content:a.string(b)+c};a.dialog(b)},loader:function(a){if(a){0<c("img#easyblog-loader").length&&
c("img#easyblog-loader").remove();a=new Image;a.src="/components/com_easyblog/assets/images/loader.gif";a.name="easyblog-loader";a.id="easyblog-loader";var e=c("div#eblog-wrapper"),f=e.width();divHeight=window.innerHeight||self.innerHeight||window.parent.document.body.clientHeight;e.prepend(a);c("img#easyblog-loader").css("marginTop",divHeight/2);c("img#easyblog-loader").css("marginLeft",f/2);c("img#easyblog-loader").css("position","absolute");c("img#easyblog-loader").css("z-index",10)}else 0<c("img#easyblog-loader").length&&
c("img#easyblog-loader").remove()}},teamblog:{join:function(b){a.load("TeamBlog","showDialog",String(b),"join")},leave:function(b){a.load("TeamBlog","showDialog",String(b),"leave")},leaveteam:function(){h.loader.loading("eblog_loader");a.load("teamblog","leaveTeam",a.getFormVal("#frmLeave"))},send:function(){h.loader.loading("eblog_loader");a.load("teamblog","addJoinRequest",a.getFormVal("#frmJoin"))},approve:function(){},reject:function(){}},calendar:{reload:function(b,c,f,g,d,l,m){a.load(b,c,f,
g,d,l,m)},showtooltips:function(a){c(".easyblog_calendar_tooltips").hide();c("#com_easyblog_calendar_day_"+a).show()}}},a=window.ejax={http:!1,format:"text",callback:function(a){},error:!1,getHTTPObject:function(){var a=!1;if("undefined"!=typeof ActiveXObject)try{a=new ActiveXObject("Msxml2.XMLHTTP")}catch(c){try{a=new ActiveXObject("Microsoft.XMLHTTP")}catch(f){a=!1}}else if(XMLHttpRequest)try{a=new XMLHttpRequest}catch(g){a=!1}return a},call:function(b,c,f,g){b=[{view:b,callback:g},c];b=b.concat(f);
a.load.apply(this,b)},load:function(a,e){var f={success:function(){},error:function(){}};"object"==typeof a&&(f=c.extend(f,c.isFunction(a.callback)?{success:a.callback}:a.callback),a=a.view);url=eblog_site;url+="&tmpl=component";url+="&no_html=1";url+="&format=ejax";url+="&"+EasyBlog.getToken()+"=1";url+="&uid="+(new Date).getTime();var g="&view="+a+"&layout="+e;if(2<arguments.length)for(var d=2;d<arguments.length;d++){var l=arguments[d];if(c.isArray(l))for(var m=0;m<l.length;m++){var n=l[m];"string"==
typeof n&&(g+="&value"+(d-2)+"[]="+encodeURIComponent(n))}else n=l,"string"==typeof n&&(g+="&value"+(d-2)+"="+encodeURIComponent(n))}var h=this.getHTTPObject();if(h&&a&&e){var p=this;h.open("POST",url,!0);h.setRequestHeader("Content-type","application/x-www-form-urlencoded");h.onreadystatechange=function(){if(4==h.readyState)if(200==h.status){var a="";h.responseText&&(a=h.responseText);a=a.replace(/[\n\r]/g,"");try{a=eval(a)}catch(d){f.error&&f.error("Invalid response.")}p.process(a,f)}else p.error&&
(p.error(h.status),f.error&&f.error(h.status))};h.send(g)}},_string:[],string:function(b){if(void 0!=a._string[b])return a._string[b];var e=c.ajax({type:"POST",url:eblog_site+"&tmpl=component&no_html=1&controller=easyblog&task=ajaxGetSystemString",data:"data="+b,async:!1,cache:!0}).responseText;return a._string[b]=e},getFormVal:function(a){var e=[],f=null;c(":input",c(a)).each(function(){f=this.value.replace(/"/g,"&quot;");f=encodeURIComponent(f);c(this).is(":checkbox")||c(this).is(":radio")?c(this).prop("checked")&&
e.push(this.name+"="+escape(f)):e.push(this.name+"="+escape(f))});return e},process:function(b,e){for(var f=0;f<b.length;f++)switch(b[f][0]){case "script":eval("EasyBlog(function($){"+b[f][1]+"});");break;case "after":var g=b[f][1],d=b[f][2];c("#"+g).after(d);break;case "append":g=b[f][1];d=b[f][2];c("#"+g).append(d);break;case "assign":g=b[f][1];d=b[f][2];c("#"+g).html(d);break;case "value":g=b[f][1];d=b[f][2];c("#"+g).val(d);break;case "prepend":g=b[f][1];d=b[f][2];c("#"+g).prepend(d);break;case "destroy":g=
b[f][1];c("#"+g).remove();break;case "dialog":a.dialog(b[f][1]);break;case "alert":a.alert(b[f][1],b[f][2],b[f][3],b[f][4]);break;case "error":g=b[f].slice(1);e.error.apply(this,g);break;case "callback":g=b[f].slice(1),e.success.apply(this,g)}delete b},dialog:function(b){a._showPopup(b)},closedlg:function(){var b=c("#eblog-dialog"),e=c("#eblog-overlay"),f=b.data("options");e.hide();b.fadeOut(function(){f.afterClose.apply(b)});c(window).unbind(".dialog");c(document).unbind("keyup",a._attachPopupShortcuts)},
_attachPopupShortcuts:function(b){27==b.keyCode&&a.closedlg()},alert:function(b,c,f,g){var d='<div class="dialog-actions"><input type="button" value="'+a.string("COM_EASYBLOG_OK")+'" class="button" id="edialog-cancel" name="edialog-cancel" onclick="ejax.closedlg();" /></div>';a._showPopup({title:c,content:b+d,width:f,height:g})},_showPopup:function(b){b=c.extend({},{width:"500",height:"auto",type:"dialog",beforeDisplay:function(){},afterDisplay:function(){},afterClose:function(){}},b);var e=c("#eblog-overlay");
1>e.length&&(e='<div id="eblog-overlay"></div>',e=c(e).appendTo("body"),e.click(function(){a.closedlg()}));var f=c("#eblog-dialog");1>f.length&&(dialogTemplate='<div id="eblog-dialog">',dialogTemplate+='\t<div class="dialog">',dialogTemplate+='\t\t<div class="dialog-wrap">',dialogTemplate+='\t\t\t<div class="dialog-top">',dialogTemplate+="\t\t\t\t<h3></h3>",dialogTemplate+='\t\t\t\t<a href="javascript:void(0);" onclick="ejax.closedlg();" class="closeme">Close</a>',dialogTemplate+="\t\t\t</div>",dialogTemplate+=
'\t\t\t<div class="dialog-middle clearfix">',dialogTemplate+='\t\t\t\t<div class="dialog-middle-content"></div>',dialogTemplate+="\t\t\t</div>",dialogTemplate+="\t\t</div>",dialogTemplate+="\t</div>",dialogTemplate+="</div>",f=c(dialogTemplate).appendTo("body"));f.data("options",b);var g=f.find(".dialog-top h3");b.title=null!=b.title?b.title:"&nbsp;";g.html(unescape(b.title));c("#eblog-dialog .dialog-middle-content").css({width:"auto"==b.width?"auto":parseInt(b.width),height:"auto"==b.height?"auto":
parseInt(b.height)}).html(b.content);b.beforeDisplay.apply(f);var d=function(){f.css({top:0,left:0}).position({my:"center",at:"center",of:window});e.css({width:c(document).width(),height:c(document).height()}).show()};f.show(0,function(){d();var a;c(window).bind("resize.dialog scroll.dialog",function(){clearTimeout(a);a=setTimeout(d,50)})});f.fadeOut(0,function(){f.fadeIn(function(){b.afterDisplay.apply(f)})});c(document).on("click.eb.dialog","#edialog-cancel, #edialog-submit",function(){a.closedlg()});
...
1;var b=a.sliderItems().length*parseInt(a.options.itemWidth);a.slider().css("width",b);a.sliderItems().css("width",a.options.itemWidth);a.options.autorotate.enabled&&setTimeout(function(){a.initAutoRotate()},1E3*parseInt(a.options.autorotate.interval))},nextItem:function(b){var e=c(b).data("slider"),f=0;1!=e&&(f=a.options.itemWidth*parseInt(e-1));a.slider().children(":nth-child("+e+")").show();a.slider().animate({left:"-"+f+"px"},"slow");a.sliderNavigation(".active").removeClass("active");c(b).addClass("active")},
"{sliderNavigation} click":function(b){a.nextItem(b)},initAutoRotate:function(){var b=!1;a.sliderNavigation().each(function(){c(this).hasClass("active")&&!0!=b&&(0==c(this).next().length?a.nextItem(a.sliderNavigation(":first")):a.nextItem(c(this).next()),b=!0)});setTimeout(function(){a.initAutoRotate()},1E3*parseInt(a.options.autorotate.interval))}}});h.resolve()})});EasyBlog.module("location",function(c){var h=this;EasyBlog.require().library("ui/autocomplete").done(function(){EasyBlog.Controller("Location.Form",
{defaultOptions:{language:"en",initialLocation:null,mapType:"ROADMAP","{locationInput}":".locationInput","{locationLatitude}":".locationLatitude","{locationLongitude}":".locationLongitude","{locationMap}":".locationMap","{autoDetectButton}":".autoDetectButton"}},function(a){return{init:function(){var b=c.uid("ext");window[b]=function(){c.___GoogleMaps.resolve()};c.___GoogleMaps||(c.___GoogleMaps=c.Deferred(),EasyBlog.require().script({prefetch:!1},"https://maps.googleapis.com/maps/api/js?sensor=true&language="+
a.options.language+"&callback="+b));c.___GoogleMaps.done(function(){a._init()})},_init:function(b,e){a.geocoder=new google.maps.Geocoder;a.hasGeolocation=void 0!==navigator.geolocation;a.hasGeolocation?a.autoDetectButton().show():a.autoDetectButton().remove();a.locationInput().autocomplete({delay:300,minLength:0,source:a.retrieveSuggestions,select:function(b,d){a.locationInput().autocomplete("close");a.setLocation(d.item.location)}}).prop("disabled",!1);a.autocomplete=a.locationInput().autocomplete("widget");
a.autocomplete.addClass("location-suggestion");var f=c.trim(a.options.initialLocation);f&&a.getLocationByAddress(f,function(b){a.setLocation(b[0])});a.busy(!1)},busy:function(b){a.locationInput().toggleClass("loading",b)},getUserLocations:function(b){a.getLocationAutomatically(function(c){a.userLocations=a.buildDataset(c);b&&b(c)})},getLocationByAddress:function(b,c){a.geocoder.geocode({address:b},c)},getLocationByCoords:function(b,c,f){a.geocoder.geocode({location:new google.maps.LatLng(b,c)},f)},
getLocationAutomatically:function(b,c){if(!navigator.geolocation)return c("ERRCODE","Browser does not support geolocation or do not have permission to retrieve location data.");navigator.geolocation.getCurrentPosition(function(c){a.getLocationByCoords(c.coords.latitude,c.coords.longitude,b)},c)},renderMap:function(b,c){a.busy(!0);a.locationMap().show();var f=new google.maps.Map(a.locationMap()[0],{zoom:15,center:b.geometry.location,mapTypeId:google.maps.MapTypeId[a.options.mapType],disableDefaultUI:!0}),
g=new google.maps.Marker({position:b.geometry.location,center:b.geometry.location,title:b.formatted_address,map:f}),d=new google.maps.InfoWindow({content:c});google.maps.event.addListener(f,"tilesloaded",function(){d.open(f,g);a.busy(!1)})},setLocation:function(b){b&&(a.locationResolved=!0,a.lastResolvedLocation=b,a.locationInput().val(b.formatted_address),a.locationLatitude().val(b.geometry.location.lat()),a.locationLongitude().val(b.geometry.location.lng()),a.renderMap(b,b.formatted_address))},
...
center.longitude):a.locations[0];a.map=new google.maps.Map(a.locationMap()[0],{zoom:parseInt(a.options.zoom),minZoom:parseInt(a.options.minZoom),maxZoom:parseInt(a.options.maxZoom),center:b,mapTypeId:google.maps.MapTypeId[a.options.mapType],disableDefaultUI:a.options.disableMapsUI});google.maps.event.addListener(a.map,"tilesloaded",function(){!1==a.mapLoaded&&(a.mapLoaded=!0,a.loadLocations())})},loadLocations:function(){a.bounds=new google.maps.LatLngBounds;a.infoWindow=[];setTimeout(function(){c.each(a.locations,
function(b,c){a.bounds.extend(c);setTimeout(function(){a.addMarker(c,a.options.locations[b])},100*(b+1))});a.options.fitBounds&&a.map.fitBounds(a.bounds)},500)},addMarker:function(b,c){if(b){var f=new google.maps.Marker({position:b,map:a.map});f.setAnimation(google.maps.Animation.DROP);a.addInfoWindow(f,c)}},addInfoWindow:function(b,e){var f=e.content;f||(f=e.address);var g=new google.maps.InfoWindow;g.setContent(f);a.infoWindow.push(g);1<a.options.locations.length?google.maps.event.addListener(b,
"click",function(){c.each(a.infoWindow,function(a,b){b.close()});g.open(a.map,b)}):(google.maps.event.addListener(b,"click",function(){g.open(a.map,b)}),g.open(a.map,b));e.ratingid&&google.maps.event.addListener(g,"domready",function(){c.each(e.ratingid,function(a,b){eblog.ratings.setup("ebpostmap_"+b+"-ratings",!0,"entry");c("#ebpostmap_"+b+"-ratings").removeClass("ui-state-disabled");c("#ebpostmap_"+b+"-ratings-form").find(".blog-rating-text").hide();c("#ebpostmap_"+b+"-ratings .ratings-value").hide()})})}}});
h.resolve()})});EasyBlog.module("media",function(c){var h=this,a=function(a){return c("<div>").text(a).html().replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/'/g,"&apos;")},b,e;EasyBlog.Controller("Media",{defaultOptions:{debug:{logging:EasyBlog.debug,itemVisibility:!1,delayConfiguration:0,delayCommon:0,delayBrowser:0,delayUploader:0,delayEditor:0},ui:"#EasyBlogMediaManagerUI",overlay:{background:"black",opacity:0},modal:{size:0.9},recentActivities:{hideAfter:3E3},"{modalGroup}":".mediaModalGroup",
"{modal}":".mediaModal","{loaderModal}":".loaderModal","{uploaderModal}":".uploaderModal","{browserModal}":".browserModal","{editorModal}":".editorModal","{modalContent}":".modalContent","{overlay}":".media-overlay","{modalDashboardButton}":".dashboardButton","{assetItem}":".assetItem"}},function(a){return{console:function(d,b){if(a.options.debug.logging){var c=window.console;c&&(d=c[d])&&(d.apply?d.apply(c,b):d(b.join(" ")))}},assets:{},getAsset:function(d){void 0===a.assets[d]&&(a.assets[d]=c.Deferred()).done(function(){a.assetItem(".asset-type-"+
d).removeClass("loading done failed").addClass("done")}).fail(function(){a.assetItem(".asset-type-"+d).removeClass("loading done failed").addClass("fail")});return a.assets[d]},createAsset:function(d,b,c){var e=a.getAsset(d);e.factory=b;setTimeout(function(){e.factory&&e.factory(e)},c);return e},init:function(){b=a;a.IE=function(){for(var a=3,d=document.createElement("div"),b=d.getElementsByTagName("i");d.innerHTML="\x3c!--[if gt IE "+ ++a+"]><i></i><![endif]--\x3e",b[0];);return 4<a?a:void 0}();
if("undefined"!=typeof tinyMCE&&tinyMCE&&tinyMCE.isIE&&9==a.IE)var d=setInterval(function(){var b=tinyMCE.editors.write_content;b&&(c(b.contentWindow).off("keydown.mediaManager mousedown.mediaManager focus.mediaManager").on("keydown.mediaManager mousedown.mediaManager focus.mediaManager",function(){a.bookmark={element:b.selection.getEnd(),range:b.selection.getBookmark(1).rng}}),clearInterval(d))},500);a.originalBodyOverflow=c("body").css("overflow");a.createAsset("configuration",function(d){EasyBlog.module("media/configuration").done(function(){a.initialize(this);
d.resolve()}).fail(function(){d.reject()})},a.options.debug.delayConfiguration);a.createAsset("common",function(a){EasyBlog.require().script("media/navigation").view("media/recent.item","media/browser","media/browser.item-group","media/browser.item","media/browser.tree-item-group","media/browser.tree-item","media/browser.pagination-page","media/browser.uploader","media/browser.uploader.item","media/editor","media/editor.viewport","media/navigation.item","media/navigation.itemgroup").language("COM_EASYBLOG_MM_UNABLE_TO_FIND_EXPORTER",
...
a.options.debug.delayCommon);a.createAsset("uploader",function(d){c.when(a.getAsset("configuration"),a.getAsset("common"),EasyBlog.require().script("media/uploader").done()).done(function(){var b=a.createModal("uploader");b.controller=new EasyBlog.Controller.Media.Uploader(b.element,a.options.uploader);d.resolve()}).fail(function(){d.reject()})},a.options.debug.delayUploader);a.createAsset("browser",function(d){c.when(a.getAsset("configuration"),a.getAsset("common"),EasyBlog.require().script("media/browser").done()).done(function(){var b=
a.createModal("browser");b.controller=new EasyBlog.Controller.Media.Browser(b.element,a.options.browser);d.resolve()}).fail(function(){d.reject()})},a.options.debug.delayBrowser);a.createAsset("editor",function(d){c.when(a.getAsset("browser"),EasyBlog.require().script("media/editor").done()).done(function(){var b=a.createModal("editor");b.controller=new EasyBlog.Controller.Media.Editor(b.element,a.options.editor);d.resolve()}).fail(function(){d.reject()})},a.options.debug.delayEditor);a.setLayout=
c.debounce(a._setLayout,200)},initialize:function(d){var b={controller:{media:a}};d=c.extend(!0,d,{browser:b,uploader:b,library:b,editor:b,exporter:b});a.update(d);e=d.directorySeparator;d=c(a.options.ui);a.element.append(d.html());d.remove();a.overlay().css(a.options.overlay);a.loader=new EasyBlog.Controller.Media.Loader(a.createModal("loader"),{controller:{media:a}});a.element.implement(EasyBlog.Controller.Media.Library,a.options.library,function(){});a.element.implement(EasyBlog.Controller.Media.Exporter,
a.options.exporter);h.resolve()},setLayout:function(){a._setLayout()},_setLayout:function(){a.layout=a.element.hasClass("active")?c.uid():null;a.layout&&a.setModalLayout();return a.layout},modals:{},createModal:function(d){var b=a.modal("."+d+"Modal");1>b.length&&(b=c('<div class="mediaModal"></div>').addClass(d+"Modal").appendTo(a.modalGroup()));return a.modals[d]={name:d,element:b}},activateModal:function(d,b){if(void 0===a.modals[d])a.loader.when(a.assets[d]).done(function(){setTimeout(function(){a.activateModal(d,
b)},1E3)});else{if(a.currentModal===d)return!0;var c=a.modals[d];if(!c)return!1;a.deactivateModal(a.currentModal);a.currentModal=d;a.show();(c=c.controller)&&c.trigger("modalActivate",b);return!0}},deactivateModal:function(d,b){var c=a.modals[d];if(!c)return!1;var e=c.controller;if(e)try{e.trigger("modalDeactivate",b)}catch(f){console.error(f)}c.element.removeClass("active");a.currentModal=void 0;return!0},setModalLayout:function(){clearTimeout(a.setModalLayout.task);var d=a.modals[a.currentModal];
if(d){if(!a.layout)return a._setLayout();d.element.addClass("active");var b=d.controller;if(b&&c.isFunction(b.setLayout)){var e=function(){var d=b.element.offset();0===d.top||0===d.left?a.setModalLayout.task=setTimeout(e,50):b.setLayout()};e()}}},show:function(){a.element.addClass("active");a._setLayout();a.trigger("showModal")},hide:function(){a.element.removeClass("active");a.deactivateModal(a.currentModal);a.trigger("hideModal")},"{overlay} click":function(){a.hide()},"{window} resize":function(){a.setLayout()},
"{modalDashboardButton} click":function(d,b){if(b.shiftKey)return a.console("dir",[a]);a.hide()},upload:function(){a.activateModal("uploader",arguments)},browse:function(){a.activateModal("browser",arguments)},edit:function(){a.activateModal("editor",arguments)}}});EasyBlog.Controller("Media.Loader",{defaultOptions:{}},function(a){return{init:function(){},when:function(){a.media.activateModal("loader");var d=c.when.apply(null,arguments),b=d.done;d.id=c.uid();d.done=function(c){b(function(){a.currentQueueId==
d.id&&c&&c()})};a.currentQueueId=d.id;return d},"{self} hide":function(){a.currentQueueId=null}}});EasyBlog.Controller("Media.Prompt",{defaultOptions:{"{dialog}":".modalPromptDialog","{cancelButton}":".promptCancelButton"}},function(a){return{init:function(){},get:function(d){d=a.dialog("."+d);return a.instantiate(d)},instantiate:function(d){var b={element:d,show:function(){d.addClass("active");a.element.addClass("active");return b},hide:function(){d.removeClass("active");a.element.removeClass("active");
return b},state:function(a){var c=d.data("lastPromptState");if(void 0===a)return c;var g=d.find(".promptState.state-"+a),c=d.find(".promptState.state-"+c);if(!(1>g.length))return c.removeClass("active"),g.addClass("active"),d.data("lastPromptState",a),b}};return b},hideAll:function(){a.dialog().removeClass("active");a.element.removeClass("active")},"{cancelButton} click":function(){a.hideAll()}}});EasyBlog.Controller("Media.Library",{defaultOptions:{places:[],place:{files:{},acl:{canCreateFolder:!1,
canUploadItem:!1,canRenameItem:!1,canRemoveItem:!1,canCreateVariation:!1,canDeleteVariation:!1},populateImmediately:!1}}},function(a){return{init:function(){a.media.library=a;c.each(a.options.places,function(d,b){a.addPlace(b)})},places:{},getPlace:function(d){if(d){if(d.acl)return d;if("string"===typeof d)return a.places[d.split("|")[0]]}},addPlace:function(d){d=a.places[d.id]=c.extend({tasks:c.Threads({threadLimit:1}),ready:c.Deferred(),baseFolder:function(){return a.getMeta(d.id+"|"+a.media.options.directorySeparator)}},
a.options.place,d);d.done=d.ready.done;d.fail=d.ready.fail;d.always=d.ready.always;d.files=function(a){if(!c.isEmptyObject(a)){if("string"===typeof a)try{a=c.parseJSON(a)}catch(d){}return"object"===typeof a?a:void 0}}(d.files);d.files&&d.tasks.add(function(){a.importMeta(d.files);d.ready.resolve(d)});d.populate=function(){if(void 0!==d.populate.task)return d.populate.task;d.populate.task=c.Deferred();d.populate[/easysocial|jomsocial|flickr/.test(d.id)||d.files?"getFileTree":"getFolderTree"]();return d.populate.task};
d.populate.getFolderTree=function(){return a.getRemoteMeta({place:d.id,foldersOnly:1}).done(function(b){d.tasks.add(function(){a.importMeta(b);d.ready.resolve(d)});d.populate.getFileTree()}).fail(function(){d.populate.task.reject(d);delete d.populate.task;d.ready.reject(d)})};d.populate.getFileTree=function(){return a.getRemoteMeta({place:d.id}).done(function(b){d.tasks.add(function(){a.importMeta(b);d.ready.resolve(d);d.populate.task.resolve(d)})}).fail(function(){d.populate.task.reject(d);delete d.populate.task})};
d.populateImmediately&&d.populate();return d},meta:{},metadata:{},isMeta:function(a){return!(void 0===a||!c.isPlainObject(a)||c.isEmptyObject(a))},get:function(d){if(a.meta.hasOwnProperty(d)){var b=c.extend({},a.meta[d]);b.data=a.metadata[d];return b}},getKey:function(a){return a?a.place+"|"+a.path:null},getParentKey:function(d){if(d){d="string"===typeof d?d:d.key||a.getKey(d);var b=d.indexOf(e),c=d.lastIndexOf(e);return c===d.length-1?void 0:d.substring(0,c+(b===c?1:0))}},getMeta:function(d){if(d){if(a.isMeta(d))return a.get(a.getKey(d))||
d;if("string"===typeof d)return a.get(d)}},getRemoteMeta:function(d){var b=c.Deferred();b.retry=0;d=c.extend({path:a.media.options.directorySeparator,retry:3,retryAfter:1E3,variation:0,foldersOnly:0},d);if(void 0===d.place)return b.rejectWith(b,"Error: Place not given!");var e=function(){b.loader=EasyBlog.ajax("site.views.media.getMeta",d,{success:function(a){b.resolveWith(b,arguments)},fail:function(){b.rejectWith(b,arguments)},error:function(){b.retry++;b.retry<d.retry?e():b.rejectWith(b,arguments)}});
return arguments.callee}();return b},getMetaVariations:function(d){d=a.getMeta(d);if(void 0!==d)return a.getRemoteMeta({place:d.place,path:d.path,variation:1}).done(function(d){a.addMeta(d)})},removeMetaVariation:function(d,b){d=a.getMeta(d);if(void 0!==d&&void 0!==d.variations){for(var c,e=0;e<d.variations.length;e++)if(d.variations[e].name===b){c=d.variations[e];d.variations.splice(e,1);break}return c}},addMeta:function(d){var b=a.getKey(d),f=a.getMeta(b);if(f&&d.hash===f.hash)return f;d.key=b;
d.hash=c.uid();d.group="folder"==d.type?"folders":"files";d.parentKey=a.getParentKey(d);var h=a.getPlace(d.place);d.friendlyPath=d.path===e?h.title:h.title+d.path.substring(d.path.indexOf(e),d.path.length);a.meta[b]=d;b=d.data=a.metadata[b]||(a.metadata[b]=c.eventable({}));"folder"==d.type&&(b.files=b.files||{},b.folders=b.folders||{},b.views=b.views||a.createMetaView(d));f?setTimeout(function(){d.data.fire("updated",d)},0):(f=a.getMeta(d.parentKey))&&f.data.views.addMeta(d);return d},removeMeta:function(d){d=
a.getMeta(d);if(void 0!==d){if("folder"===d.type){var b=d.data.folders,c=d.data.files;for(key in b)a.removeMeta(key);for(key in c)a.removeMeta(key)}d.parentKey&&((b=a.getMeta(d.parentKey))&&b.data.views.removeMeta(d),delete a.meta[d.key],setTimeout(function(){d.data.fire("removed",d)},0));return d}},removeRemoteMeta:function(d){var b=c.Deferred();d=a.getMeta(d);if(void 0===d)return b.rejectWith(b,"The file does not exist in the media library.");b.loader=EasyBlog.ajax("site.views.media.delete",{place:d.place,
path:d.path},{success:function(){a.removeMeta(d);b.resolveWith(b,[d])},fail:function(){b.rejectWith(b,arguments)},error:function(a,d){b.rejectWith(b,[d])}});return b},createFolder:function(d,b){var f=c.Deferred();d=a.getMeta(d);var h=d.place;if(void 0===d||"folder"!==d.type)return f.rejectWith(f,"Parent folder was not found.");f.loader=EasyBlog.ajax("site.views.media.createFolder",{place:h,path:d.path+e+b},{success:function(d){d.place=h;d=a.addMeta(d);f.resolveWith(f,[d])},fail:function(){f.rejectWith(f,
arguments)},error:function(a,d){f.rejectWith(f,[d])}});return f},importMeta:function(d,b){if(void 0!==d&&"folder"===d.type){void 0===b&&(b=!0);var c=d.contents,e=c.length;delete d.contents;c.reverse();for(var f=a.addMeta(d),h=f.data,r={files:{},folders:{}},t=0;t<e;){d=a.addMeta(c[t]);var s=d.key,v=d.group;r[v][s]=delete h[v][s];t++}for(s in h.files)a.removeMeta(s);for(s in h.folders)a.removeMeta(s);h.folders=r.folders;h.files=r.files;if(b)for(s in h.folders)a.importMeta(a.getMeta(s),b);return f}},
createMetaView:function(d){var b={meta:d,addMeta:function(a){for(mode in b.modes){var d=b.modes[mode][a.group];d&&d.add(a)}},removeMeta:function(a){for(mode in b.modes){var d=b.modes[mode][a.group];d&&d.remove(a)}},create:function(a){var d=c.Callbacks("unique memory");c.extend(d,{from:0,to:1024,mode:"dateModified",group:"files"},a,{uid:c.uid(),select:function(a){c.extend(d,a);d.map&&delete d.map.monitors[d.uid];d.map=b.modes[d.mode][d.group];d.map.monitors[d.uid]=d;return d.refresh()},updated:d.add,
refresh:function(){return d.fire(d.map.slice(d.from,d.to))},destroy:function(){d.disable();d.map&&delete d.map.monitors[d.uid];return d}});return d.select()}};a.createViewModes(b);return b},createViewModes:function(d){d.modes={dateModified:{folders:a.createViewMap(d,!0),files:a.createViewMap(d)}};return d},createViewMap:function(a,b){var g=c.extend([],{task:c.Threads({threadLimit:1}),affectedIndex:[],add:function(a){g.task.add(function(){g.unshift(a.key);g.affectedIndex.push(0);b&&g.sort().reverse();
g.refreshMonitor()})},remove:function(a){g.task.add(function(){for(var d=a.key,b=g.length,c;b--;)if(g[b]===d){c=b;break}void 0!==c&&(g.splice(b,1),g.affectedIndex.push(b),g.refreshMonitor())})},monitors:{},refreshMonitor:function(){clearTimeout(g.refreshMonitor.timer);g.refreshMonitor.timer=setTimeout(function(){var a=g.affectedIndex;g.affectedIndex=[];g.task.add(function(){var d=a.length,b=0;for(id in g.monitors)for(var c=g.monitors[id],e=c.from,l=c.to,b=0;b<d;b++){var f=a[b];if(f>=e||f<=l){c.refresh();
break}}})},250)}});return g},search:function(d){if(""===c.trim(d))return[];d=d.toLowerCase();var b=a.createMetaView({type:"search"});for(key in a.meta){var e=key.split("|"),f=e[1],h=a.meta[key];/easysocial|jomsocial|flickr/.test(e[0])&&(f=h.title||"");f.toLowerCase().match(d)&&b.addMeta(h)}return b}}});EasyBlog.Controller("Media.Exporter",{defaultOptions:{view:{recentItem:"media/recent.item"},"{recentActivities}":".recentActivities","{recentActivitiesDialog}":".recentActivities .modalPromptDialog",
...
a.recentActivitiesDialog().removeClass("active")}})},"{dashboardButton} click":function(){a.hideDialog()},"{hideRecentActivitiesButton} click":function(){a.hideDialog()},insert:function(d,e){var f=b.library.getMeta(d);if(void 0!==f){var h=a.create(f.type,f.key,e);a.showDialog();h.recentItem=a.view.recentItem({meta:f}).addClass("loading").css({opacity:0}).prependTo(a.recentItemGroup()).animate({opacity:1},{duration:500,complete:function(){h.done(function(d){""===d&&h.recentItem.removeClass("loading done").addClass("error").find(".itemProgress").html(c.language("COM_EASYBLOG_MM_UNABLE_TO_EXPORT_ITEM"));
if("undefined"!=typeof tinyMCE)if(tinyMCE&&tinyMCE.isIE&&9==b.IE){var e=b.bookmark;if(e){var f=tinyMCE.editors.write_content;f.selection.moveToBookmark({rng:e.range});f.execCommand("mceInsertContent",!1,d)}else EasyBlog.dashboard.editor.insert(d)}else EasyBlog.dashboard.editor.insert(d);else EasyBlog.dashboard.editor.insert(d);h.recentItem.removeClass("loading failed").addClass("done").find(".itemProgress").html(c.language("COM_EASYBLOG_MM_ITEM_INSERTED"));0<b.options.recentActivities.hideAfter&&
setTimeout(function(){a.hideDialog()},b.options.recentActivities.hideAfter)}).progress(function(a){h.recentItem.hasClass("done")||h.recentItem.find(".itemProgress").html(a)}).fail(function(a){h.recentItem.removeClass("loading done").addClass("error").find(".itemProgress").html(a)})}});return h}},create:function(d,b,e){var f=a.handler[d],h=c.Deferred();if(void 0===f){f=EasyBlog.Controller.Media.Exporter[c.String.capitalize(d)];if(void 0===f)return h.reject(c.language("COM_EASYBLOG_MM_UNABLE_TO_FIND_EXPORTER")),
h;f=a.handler[d]=new f(a.element,c.extend({},{settings:a.options[d],controller:{media:a.media}}))}f.create(h,b,e);return h}}});EasyBlog.Controller("Media.Exporter.File",{defaultOptions:{settings:{title:"",target:"_self",content:""}}},function(a){return{init:function(){},create:function(d,b,f){f=c.extend({},a.options.settings,f);b=a.media.library.getMeta(b);b=c(document.createElement("A")).attr({title:f.title,target:f.target,href:b.url}).html(f.content?f.content:b.title);d.resolve(b.toHTML());return d}}});
EasyBlog.Controller("Media.Exporter.Folder",{defaultOptions:{settings:{}}},function(a){return{init:function(){},create:function(d,b,f){f=c.extend({},a.options.settings,f);b=a.media.library.getMeta(b);var e="jomsocial"==b.place||"easysocial"==b.place?"album":"gallery";f.file=b.path;f.place=b.place;f="[embed="+e+"]"+JSON.stringify(f)+"[/embed]";d.resolve(f);return d}}});EasyBlog.Controller("Media.Exporter.Image",{defaultOptions:{settings:{zoom:null,caption:null,lightbox:!1,enforceDimension:!1,enforceWidth:null,
enforceHeight:null,variation:null,defaultVariation:"thumbnail",defaultZoom:"original"}}},function(b){return{init:function(){},create:function(d,f,e){var h=c.extend({},b.options.settings,e),k=b.media.library.getMeta(f),p=c(new Image);e=a(k.title);p.attr({src:k.thumbnail.url,alt:e,title:e});var r=function(){var b={};c.each(k.variations,function(a,d){b[d.name]=d});var f=b[h.variation]||b[h.defaultVariation]||k.variations[0],g=a(f.title);p.attr({src:f.url,alt:g,title:g});h.enforceDimension&&null!==h.enforceWidth&&
null!==h.enforceHeight&&(g=c.Image.resizeWithin(f.width,f.height,h.enforceWidth,h.enforceHeight),g.width=Math.floor(g.width),g.height=Math.floor(g.height),p.attr(g));null!==h.caption&&(g=a(h.caption),p.addClass("easyblog-image-caption").attr("title",g));null!==h.zoom&&(f=b[h.zoom]||b[h.defaultZoom]||{url:k.thumbnail.url,title:k.title},g=a(h.caption||f.title||""),p=c("<a>").addClass("easyblog-thumb-preview").attr({href:f.url,title:g}).html(p));d.resolve(p.toHTML())};h.variation||h.zoom||h.enforceWidth||
h.enforceHeight?void 0===k.variations?(d.notify(c.language("COM_EASYBLOG_MM_GETTING_IMAGE_SIZES")),b.media.library.getMetaVariations(f).done(function(a){k=a;r()}).fail(function(){d.reject(c.language("COM_EASYBLOG_MM_UNABLE_TO_RETRIEVE_VARIATIONS"))})):r():d.resolve(p.toHTML());return d}}});EasyBlog.Controller("Media.Exporter.Audio",{defaultOptions:{width:400,height:24,autostart:!1,controlbar:"bottom",backcolor:"#333333",frontcolor:"#ffffff"}},function(a){return{init:function(){},create:function(d,
b,f){f=c.extend({},a.options.settings,f);b=a.media.library.getMeta(b);f.file=b.path;f.place=b.place;b="[embed=audio]"+JSON.stringify(f)+"[/embed]";d.resolve(b);return d}}});EasyBlog.Controller("Media.Exporter.Video",{defaultOptions:{settings:{width:400,height:225,autostart:!1,controlbar:"bottom",backcolor:"#333333",frontcolor:"#ffffff"}}},function(a){return{init:function(){},create:function(d,b,f){f=c.extend({},a.options.settings,f);b=a.media.library.getMeta(b);f.file=b.path;f.place=b.place;b="[embed=video]"+
JSON.stringify(f)+"[/embed]";d.resolve(b);return d}}});EasyBlog.Controller("MediaLauncher",{defaultOptions:{"{uploadImageButton}":".uploadImageButton","{chooseImageButton}":".chooseImageButton"}},function(a){return{init:function(){c("#media_manager_button").click(function(){EasyBlog.mediaManager.browse()})},"{uploadImageButton} click":function(){EasyBlog.mediaManager.upload()},"{chooseImageButton} click":function(){EasyBlog.mediaManager.browse()}}});var f=c(document.createElement("div")).attr("id",
"EasyBlogMediaManager").appendTo("body");EasyBlog.mediaManager=new EasyBlog.Controller.Media(f)});EasyBlog.module("media/navigation",function(c){var h=this;EasyBlog.require().done(function(){var a,b,e;EasyBlog.Controller("Media.Navigation",{defaultOptions:{view:{item:"media/navigation.item",itemGroup:"media/navigation.itemgroup"},nestLevel:8,groupCollapseDelay:1E3,canActivate:!0,"{itemGroup}":".navigationItemGroup","{item}":".navigationItem"}},function(f){return{init:function(){a=f.media;b=a.library;
e=a.options.directorySeparator;f.element.toggleClass("canActivate",f.options.canActivate)},setPathway:function(a){if(a=b.getMeta(a)){f.currentKey=a.key;var d=b.getPlace(a.place),l=a.path,h="folder"===a.type,n=l.split(e).splice(1),k=f.options.nestLevel,p=n.length-(n.length%k||k),r;f.element.empty().toggleClass("type-folder",h);f.view.item({title:d.title||e}).addClass("base").data("key",d.id+"|"+e).appendTo(f.element);var t="jomsocial"===d.id;l!==e&&c.each(n,function(c,l){var q=!h&&c==n.length-1,u=
e+n.slice(0,c+1).join(e),u=d.id+"|"+u;l=t?b.getMeta(u).title:l;q=f.view.item({title:q?a.title:l}).data("key",u).toggleClass("filename",q);c>=p?q.appendTo(f.element):(0==c%k&&(r=f.view.itemGroup().appendTo(f.element)),q.appendTo(r))})}},"{itemGroup} mouseover":function(a){clearTimeout(a.data("delayCollapse"));a.addClass("expand")},"{itemGroup} mouseout":function(a){a.data("delayCollapse",setTimeout(function(){a.removeClass("expand")},f.options.groupCollapseDelay))},"{item} click":function(a){f.options.canActivate&&
(a=a.data("key"),f.trigger("activate",a))}}});h.resolve()})});EasyBlog.module("media/uploader",function(c){var h=this;EasyBlog.require().library("plupload").done(function(){var a,b,e,f;EasyBlog.Controller("Media.Uploader",{defaultOptions:{view:{uploader:"media/browser.uploader",uploadItem:"media/browser.uploader.item"},"{modalHeader}":".modalHeader","{modalToolbar}":".modalToolbar","{modalContent}":".modalContent","{modalFooter}":".modalFooter","{modalPrompt}":".modalPrompt","{modalBrowserButton}":".modalButton.browserButton",
"{modalDashboardButton}":".modalButton.dashboardButton","{uploadButton}":".uploadButton","{uploadNavigation}":".uploadNavigation","{uploadForm}":".uploadForm","{uploadPath}":".uploadPath","{uploadSize}":".uploadSize","{uploadExtensionList}":".uploadExtensionList","{uploadItemGroup}":".uploadItemGroup","{uploadItem}":".uploadItem","{uploadDropHint}":".uploadDropHint","{uploadInstructions}":".uploadInstructions","{clearListButton}":".clearListButton"}},function(g){return{init:function(){a=g.media;b=
a.library;e=a.uploader=g;f=a.options.directorySeparator;g.element.addClass("uploader").html(g.view.uploader({uploadSize:g.options.settings.max_file_size,uploadExtensionList:g.options.settings.filters[0].extensions.split(",").join(", ")}));g.uploadNavigation().implement(EasyBlog.Controller.Media.Navigation,{controller:g.controllerProps()},function(){g.navigation=this});g.modalPrompt().implement(EasyBlog.Controller.Media.Prompt,{controller:g.controllerProps()},function(){g.promptDialog=this});g.element.implement(EasyBlog.Controller.Media.Uploader.FolderSwitcher,
{controller:g.controllerProps()},function(){g.folderSwitcher=this});g.element.implement("plupload",{settings:g.options.settings,"{uploadButton}":g.options["{uploadButton}"],"{uploadDropsite}":g.options["{uploadItemGroup}"]},function(){g.plupload=this.plupload;if("html4"==g.plupload.runtime||c.browser.msie){g.uploadDropHint().remove();g.uploadItemGroup().addClass("indefinite-progress");var d=g.uploadInstructions().appendTo(a.element);g.element.find("> form").mouseover(function(){var b=g.uploadButton(),
f=b.offset();d.addClass("show").css({top:f.top+b.outerHeight()-a.element.offset().top+3,right:c(window).width()-(f.left+b.outerWidth())-1})}).mouseout(function(){d.removeClass("show")})}else g.uploadButton().mouseover(function(){g.uploadInstructions().addClass("show")}).mouseout(function(){g.uploadInstructions().removeClass("show")})});g.setLayout()},setLayout:function(){if("uploader"===a.currentModal){var d;g.modalContent().hide().height(d=g.element.height()-g.modalHeader().outerHeight()-g.modalToolbar().outerHeight()-
g.modalFooter().outerHeight()).show();c.browser.msie&&(g.uploadDropHint().height(d),g.uploadItemGroup().height(d));g.plupload&&g.plupload.refresh()}},controllerProps:function(a){return c.extend({media:g.media,uploader:g},a||{})},setUploadFolder:function(a){a&&(g.navigation.setPathway(a),g.currentUploadFolder=a)},items:{},createItem:function(a){var b=new EasyBlog.Controller.Media.Uploader.Item(g.view.uploadItem(),{controller:g.controllerProps({id:a.id,originalFile:a,uploadFolder:g.currentUploadFolder})});
b.element.appendTo(g.uploadItemGroup());var f=b.file().filesize,f=f?"":" ("+f+").";b.setMessage(c.language("COM_EASYBLOG_MM_UPLOADING_PENDING")+f);return g.items[a.id]=b},"{self} BeforeUpload":function(a,f,e,h){h=g.items[h.id];if(void 0!==h){h.setMessage(c.language("COM_EASYBLOG_MM_UPLOAD_PREPARING"));a=g.options.settings.url;var k=b.getMeta(h.uploadFolder);f=k?k.place:h.uploadFolder.split("|")[0];h=encodeURIComponent(k?k.path:h.uploadFolder.split("|")[1]);e.settings.url=a+"&place="+f+"&path="+h}},
"{self} FilesAdded":function(a,b,f,e){try{c.each(e,function(a,b){void 0===g.items[b.id]&&g.createItem(b)}),0<g.uploadItem().length&&g.uploadItemGroup().removeClass("empty"),g.plupload.start()}catch(h){console.error(h)}},"{self} UploadFile":function(a,b,f,e){a=g.items[e.id];void 0!==a&&(a.setState("uploading"),a.setMessage(c.language("COM_EASYBLOG_MM_UPLOADING_STATE")))},"{self} UploadProgress":function(a,b,f,e){a=g.items[e.id];void 0!==a&&(a.setProgress(e.percent),a.setMessage(c.language("COM_EASYBLOG_MM_UPLOADING")+
(void 0!==e.percent?" "+e.percent+"%":"")+(void 0!==e.loaded&&void 0!==!e.size?e.size-e.loaded?" ("+c.plupload.formatSize(e.size-e.loaded)+" "+c.language("COM_EASYBLOG_MM_UPLOADING_LEFT")+")":"":"")))},"{self} FileUploaded":function(b,f,e,h,k){b=g.items[h.id];void 0!==b&&(b.response=k,c.isPlainObject(k)?c.isPlainObject(k.item)?(b.setState("done"),b.setMessage(c.language("COM_EASYBLOG_MM_UPLOAD_COMPLETE")),b.meta=k.item,b.meta.place=a.library.get(b.uploadFolder).place,"image"!==b.meta.type&&b.insertBlogImageButton().remove(),
a.library.addMeta(b.meta)):(b.setState("failed"),b.setMessage(k.message||c.language("COM_EASYBLOG_MM_UPLOAD_UNABLE_PARSE_RESPONSE"))):(b.setState("failed"),b.setMessage(c.language("COM_EASYBLOG_MM_SERVER_RETURNED_INVALID_RESPONSE"))))},"{self} FileError":function(a,b,c,f,e){a=g.items[f.id];void 0===a&&(a=g.createItem(f));a.response=e;a.setState("failed");a.setMessage(e.message);0<g.uploadItem().length&&g.uploadItemGroup().removeClass("empty")},"{self} Error":function(a,b,c,f){f.file&&(a=f.file,b=
g.items[a.id],void 0===b&&(b=g.createItem(a)),b.setState("failed"),b.setMessage(f.message));0<g.uploadItem().length&&g.uploadItemGroup().removeClass("empty")},"{modalBrowserButton} click":function(){a.browse()},"{modalDashboardButton} click":function(){a.hide()},"{uploadNavigation} activate":function(a,b,c){g.setUploadFolder(c)},"{self} modalActivate":function(b,c,f){g.setUploadFolder(f);a.browser&&g.uploadItemGroup().toggleClass("blogimage","blogimage"==a.browser.mode())},removeItem:function(a){var b=
g.items[a];void 0!==b&&(g.plupload.removeFile(b.file()),b.element.remove(),delete g.items[a]);1>g.uploadItem().length&&g.uploadItemGroup().addClass("empty")},"{clearListButton} click":function(){for(id in g.items)g.removeItem(id)}}});EasyBlog.Controller("Media.Uploader.Item",{defaultOptions:{"{filename}":".uploadFilename","{progressBar}":".uploadProgressBar progress","{percentage}":".uploadPercentage","{status}":".uploadStatus","{removeButton}":".uploadRemoveButton","{insertItemButton}":".insertItemButton",
"{locateItemButton}":".locateItemButton","{insertBlogImageButton}":".insertBlogImageButton"}},function(f){return{init:function(){var a=f.file();f.filename().html(a.name);f.setState("queued")},file:function(){var a=e.plupload.getFile(f.id)||f.originalFile;a&&(a.filesize=void 0===a.size||"N/A"==a.size?"":c.plupload.formatSize(f.file.size));return a},dblclick:function(b,c){c.shiftKey&&a.console("log",f)},setProgress:function(a){f.progressBar().attr("value",a);f.percentage().html(a)},setState:function(a){f.element.removeClass("upload-state-"+
f.state).addClass("upload-state-"+a);f.state=a},setMessage:function(a){f.status().html(a)},"{removeButton} click":function(a,b){b.stopPropagation();e.removeItem(f.id)},"{insertItemButton} click":function(){a.insert(f.meta)},"{locateItemButton} click":function(){a.browse(f.meta)},"{insertBlogImageButton} click":function(){var d=b.meta[b.getMeta(f.meta).key];EasyBlog.dashboard.blogImage.setImage(d);a.hide()}}});EasyBlog.Controller("Media.Uploader.FolderSwitcher",{defaultOptions:{view:{treeItemGroup:"media/browser.tree-item-group",
treeItem:"media/browser.tree-item"},"{changeUploadFolderButton}":".changeUploadFolderButton","{selectFolderButton}":".selectFolderButton","{treeItemField}":".browserTreeItemField","{treeItemGroup}":".browserTreeItemGroup","{treeItem}":".browserTreeItem"}},function(g){return{init:function(){var b;g.promptDialog=e.promptDialog.get("changeUploadFolderPrompt");c.each(a.library.places,function(a,c){c.acl.canUploadItem&&(c.uploaderTreeItemGroup=g.view.treeItemGroup().addClass("expanded").appendTo(g.treeItemField()),
c.uploaderTreeItem=g.view.treeItem({title:c.title}).addClass("loading").addClass("type-place").data("place",c).appendTo(c.uploaderTreeItemGroup),b||(b=c.id+"|"+f,e.setUploadFolder(b)),c.done(function(){g.createTreeItem(c.baseFolder());c.uploaderTreeItem.removeClass("loading")}))})},treeItems:{},createTreeItem:function(a){a=b.getMeta(a);return g.treeItems[a.key]||function(){var f=b.getPlace(a.place),e=b.getMeta(a.parentKey),f=g.treeItems[a.key]=(e?g.view.treeItem({title:a.title}).addClass("type-folder").insertAfter(g.treeItems[e.key]):
f.uploaderTreeItem).data("key",a.key);a.data.on("removed",function(){g.removeTreeItem(a)});a.data.views.create({group:"folders"}).updated(function(a){c.each(a,function(a,b){g.createTreeItem(b)})});return f}()},removeTreeItem:function(a){a=b.getMeta(a);var c=g.treeItems[a.key];c&&(c.remove(),e.setUploadFolder(a.parentKey))},"{treeItem} click":function(a){g.treeItem().removeClass("active");a.addClass("active")},"{changeUploadFolderButton} click":function(){(g.treeItems[g.currentUploadFolder]||g.treeItem(":first")).click();
g.promptDialog.show()},"{selectFolderButton} click":function(){var a=g.treeItem(".active").data("key");e.setUploadFolder(a);g.promptDialog.hide()}}});h.resolve()})});EasyBlog.module("media/browser",function(c){var h=this;EasyBlog.require().library("image","easing","scrollTo").script("media/browser.item").done(function(){var a,b,e,f,g;EasyBlog.Controller("Media.Browser",{defaultOptions:{view:{browser:"media/browser",itemGroup:"media/browser.item-group",item:"media/browser.item",treeItemGroup:"media/browser.tree-item-group",
...
"{footerStatus}":".browserStatus","{footerMessage}":".browserMessage","{itemActionSet}":".browserItemActionSet","{itemFieldHints}":".browserItemField .hints","{browserPagination}":".browserPagination","{currentPage}":".currentPage","{totalPage}":".totalPage","{prevPageButton}":".prevPageButton","{nextPageButton}":".nextPageButton","{pageSelection}":".pageSelection","{paginationPage}":".paginationPage","{searchInput}":".searchInput"}},function(d){return{init:function(){a=d.media;b=a.library;e=a.browser=
d;g=a.options.directorySeparator;d.iconThread=c.Threads({threadLimit:d.options.layout.iconMaxLoadThread});d.enqueue=c.Enqueue();var l=b.getPlace("flickr");d.element.addClass("browser").html(d.view.browser({canUpload:d.options.acl.canUpload,flickrCallback:l?l.options.callback:"",flickrLogin:l?l.options.login:""}));d.headerNavigation().implement(EasyBlog.Controller.Media.Navigation,{controller:d.controllerProps()},function(){d.navigation=this});d.modalPrompt().implement(EasyBlog.Controller.Media.Prompt,
{controller:d.controllerProps()},function(){f=d.promptDialog=this});d.element.implement(EasyBlog.Controller.Media.Browser.Actions,{controller:d.controllerProps()},function(){d.actions=this});d.search=c.debounce(d._search,500);d.mode("browse");a.element.bind("hideModal",function(){d.mode("browse")});d.viewMode(d.options.layout.viewMode);d.setLayout();d.on("scroll",d.itemField(),c.debounce(d["{itemField} scroll"],250));c.each(b.places,function(a,b){d.createPlace(b)});d.activatePlace(d.options.initialPlace||
b.places[0].id).done(d.enqueue(function(a){d.activateItem(a.baseFolder())}))},controllerProps:function(b){return c.extend({media:a},b||{})},items:{},createPlace:function(a){a=b.getPlace(a);a.treeItemGroup=d.view.treeItemGroup().appendTo(d.treeItemField());a.treeItem=d.view.treeItem({title:a.title}).addClass("type-place").data("place",a).appendTo(a.treeItemGroup);a.itemGroup=d.view.itemGroup().appendTo(d.itemField());return a},activatePlace:function(a){a=b.getPlace(a);if(void 0!==a){d.itemGroup().removeClass("active");
a.itemGroup.addClass("active");d.treeItem().removeClass("active");a.treeItem.addClass("active");a.activator||(a.activator=c.Deferred());if("flickr"===a.id&&!a.options.associated)return e.currentFolderStatus("flickr"),a.activator;a.populated||(a.populated=!0,d.currentFolderStatus("loading"),(/easysocial|jomsocial|flickr/.test(a.id)?a.populate():a.ready).done(function(){var b=d.createFolder(a.baseFolder());a.activator.resolveWith(a,[a,b])}).fail(function(){d.currentFolderStatus("error");a.activator.rejectWith(a,
arguments)}));return a.activator}},getItem:function(a){if(void 0!==a){if(a instanceof EasyBlog.Controller.Media.Browser.Item)return a;if("string"===typeof a)return d.items[a];if(b.isMeta(a))return d.items[b.getKey(a)]}},createItem:function(c,f){if(c=b.getMeta(c))return d.items[c.key]=new EasyBlog.Controller.Media.Browser.Item(d.view.item({meta:c}),{controller:{key:c.key,media:a}})},createFolder:function(a,f){a=b.getMeta(a);return d.getItem(a)||function(){var b=d.createItem(a),f=b.place(),e=b.parentFolder();
e?b.element.insertAfter(e.element):b.element.appendTo(f.itemGroup);b.treeItem=(e?d.view.treeItem({title:a.title}).addClass("type-folder").css("marginLeft",18*(a.path.split(g).length-1)).insertAfter(e.treeItem):f.treeItem).data("item",b);a.data.views.create({group:"folders"}).updated(function(a){c.each(a,function(a,b){d.createFolder(b)})});return b}()},createFile:function(a,c){a=b.getMeta(a);return d.getItem(a)||d.createItem(a)},removeItem:function(a){clearTimeout(d.removeItem.revert);a=d.getItem(a);
var b=a.parentFolder();a.remove();a.treeItem&&a.treeItem.remove();delete d.items[a.key];d.itemField().hasClass("searching")||(d.removeItem.revert=setTimeout(function(){b&&d.activateItem(b)},500))},focusItem:function(a,b){if(a=d.getItem(a))b?d.activateItem(a):(d.currentItem(a),a.element.removeClass("active")),d.scrollTo(a),d.trigger("itemFocus",[a])},locateItem:function(a){d.itemField().hasClass("searching")&&d.clearSearch(!0);(a=b.getMeta(a))&&d.activatePlace(a.place).done(d.enqueue(function(){var b=
"folder"===a.type,c=d.activateItem(b?a:a.parentKey);void 0!==c&&(b||c.handler.locateItem(a),(b=c.handler.folderView)&&b.refresh())}))},activateItem:function(a){if(a=d.getItem(a))return d.currentItem(a),a.activate(),d.trigger("itemActivate",[a]),a},scrollTo:function(a){(a=d.getItem(a))&&d.itemField().scrollTo(a.element,{duration:d.options.layout.scrollToItemDuration,easing:d.options.layout.scrollToItemEasing,offset:{top:-0.1*d.itemField().height()}})},currentItem:function(a){var b=d.currentItem.item;
b&&b._destroyed&&(b=d.currentItem.item=void 0);a=d.getItem(a);if(!a||a._destroyed)return b;b&&(b.element.removeClass("active focus"),"folder"!==b.meta().type&&b.parentFolder().element.removeClass("active focus"),b.place().itemGroup.removeClass("active"));a.element.addClass("active focus");(b="folder"==a.meta().type)||a.parentFolder().element.addClass("focus");a.place().itemGroup.addClass("active");d.currentFolder(b?a:a.parentFolder());d.navigation.setPathway(a.key);return d.currentItem.item=a},currentFolder:function(a){var b=
d.currentFolder.folder;b&&b._destroyed&&(b=d.currentFolder.folder=void 0);a=d.getItem(a);if(!a)return b;d.treeItem().removeClass("active");a.treeItem.addClass("active");a.meta().path!==g&&a.place().treeItemGroup.addClass("expanded");a.handler.folderView&&a.handler.refreshSeed!==d.folderRefreshSeed&&(a.handler.folderView.refresh(),a.handler.refreshSeed=d.folderRefreshSeed);return d.currentFolder.folder=a},currentFolderStatus:function(a){if(!d.itemField().hasClass("searching")||/emptySearch|ready/.test(a)){var b=
d.currentFolderStatus.lastStatus;if(void 0===a)return b;if("string"===typeof a)return b&&d.itemField().removeClass(b),d.itemField().addClass(a),d.currentFolderStatus.lastStatus=a}},setLayout:function(){if(a.layout&&"browser"===a.currentModal){var b;d.modalContent().hide().height(b=d.element.height()-d.modalHeader().outerHeight()-d.modalToolbar().outerHeight()-d.modalFooter().outerHeight()).show();c.browser.msie&&(d.treeItemField().height(b),d.itemField().height(b),d.itemFieldHints().height(b));d.setItemLayout();
d.trigger("setLayout")}},setItemStyle:function(b){if(!b){b=a.layout;if(d.setItemStyle.seed===b)return;d.setItemStyle.seed=b}b={};if("tile"==d.viewMode()){var f=function(){var a=c(document.createElement("DIV")).prependTo(d.itemField()),b=a.width();a.remove();return b}(),f=Math.floor(f*d.options.layout.tileSize);b["#EasyBlogMediaManager .browser .browserItemField.view-tile .browserItem"]={width:f+"px",height:f-24+"px"}}f=document.getElementsByTagName("head")[0];if(d.itemStyle)try{f.removeChild(d.itemStyle)}catch(e){}d.itemStyle=
document.createElement("style");d.itemStyle.type="text/css";var g="";c.each(b,function(a,b){g+=a+"{"+c.map(b,function(a,b){return b+":"+a}).join(";")+"}\n"});d.itemStyle.styleSheet?d.itemStyle.styleSheet.cssText=g:d.itemStyle.appendChild(document.createTextNode(g));f.appendChild(d.itemStyle)},setItemLayout:function(){a.layout&&"browser"===a.currentModal&&(d.setItemStyle(),setTimeout(function(){var a=[];if(d.itemField().hasClass("searching"))d.searchItemGroup&&(a=d.searchItemGroup.find(".browserItem"));
else{var b=d.currentFolder();if(void 0===b)return;a=b.childItem()}if(!(1>a.length)){var c=d.itemField().offset(),f,e,g=a.length,b=1;if(!(1>a.length)){for(;1<Math.abs(g-b);)f=a.eq(b-1),e=f.offset(),0>e.top-c.top+f.outerHeight()?b=Math.ceil((g+b)/2):(g=b,b=Math.ceil(g/2));1===b&&(b=0);var c=b,h=a.length-1;for(setLayout=function(b){if(0>b||b>h)return!1;b=a.eq(b).data("item");if(!b.isVisible())return!1;b.setLayout()};!1!==setLayout(c);)c--;for(;!1!==setLayout(b);)b++}}},0))},viewMode:function(a){var b=
d.viewMode.mode;b||(b=d.viewMode.mode=d.options.layout.viewMode);void 0!==a&&(d.setItemStyle.seed=null,d.itemField().removeClass("view-"+b).addClass("view-"+a),d.viewMode.mode=b=a,d.setLayout(),a=d.currentItem(),void 0!==a&&d.scrollTo(a));return b},mode:function(a){if(void 0===a)return d.mode.currentMode||"browse";switch(a){case "browse":d.element.removeClass("mode-blogimage").addClass("mode-browse");c.each(b.places,function(a,b){/easysocial|jomsocial|flickr/.test(b.id)&&(b.treeItemGroup&&b.treeItemGroup.show(),
b.itemGroup&&b.itemGroup.show())});break;case "blogimage":d.element.addClass("mode-blogimage").removeClass("mode-browse");var f=d.currentItem(),e=!1;f&&/easysocial|jomsocial|flickr/.test(f.place().id)&&(e=!0);c.each(b.places,function(a,b){/easysocial|jomsocial|flickr/.test(b.id)?(b.treeItemGroup&&b.treeItemGroup.hide(),b.itemGroup&&b.itemGroup.hide()):e&&(e=!1,b.treeItem&&b.treeItem.click())})}d.mode.currentMode=a},"{self} itemActivate":function(a,b,c){d.itemActionSet().removeClass("active");"folder"==
c.meta().type?d.itemActionSet(".type-folder").addClass("active"):d.itemActionSet(".type-item").addClass("active")},"{headerNavigation} activate":function(a,b,c){d.activateItem(c)},"{tileViewButton} click":function(a,b){a.addClass("active").siblings().removeClass("active");d.viewMode("tile")},"{listViewButton} click":function(a,b){a.addClass("active").siblings().removeClass("active");d.viewMode("list")},"{treeItem} click":c.debounce(function(a,b){d.clearSearch(!0);var f=a.data("item");a.hasClass("type-place")?
(f=a.data("place"),c(b.target).hasClass("treeItemToggle")&&f.treeItemGroup.toggleClass("expanded"),d.activatePlace(f).done(d.enqueue(function(a,b){"jomsocial"===a.id&&a.treeItemGroup.addClass("expanded");"easysocial"===a.id&&a.treeItemGroup.addClass("expanded");d.activateItem(b)}))):d.activateItem(f)},50),"{itemField} scroll":function(a,b){d.setItemLayout()},"{item} click":function(a,b){b.stopPropagation();var c=a.data("item");if(void 0!==c){var f=c.place();d.activatePlace(f).done(d.enqueue(function(a,
b){d.activateItem(c)}))}},"{item} dblclick":function(c,f){f.stopPropagation();var e=c.data("item");f.shiftKey?a.console("log",[e]):void 0!==e&&"folder"!=e.meta().type&&("blogimage"===d.mode.currentMode?"image"==e.meta().type&&(EasyBlog.dashboard.blogImage.setImage(b.meta[e.key]),a.hide()):a.edit(e.key))},"{modalUploaderButton} click":function(){var b=d.currentFolder();a.upload(b.place().acl.canUploadItem?b.key:"")},"{self} modalActivate":function(a,c,f,e){void 0!==e&&d.mode(e);(f=b.getMeta(f)||d.currentItem().meta())&&
d.locateItem(f)},"{prevPageButton} click":function(){e.currentFolder().handler.changePage("prev")},"{nextPageButton} click":function(){e.currentFolder().handler.changePage("next")},"{pageSelection} click":function(a){1<d.paginationPage().length&&a.toggleClass("expanded")},"{paginationPage} click":function(a){if(d.pageSelection().hasClass("expanded")&&!a.hasClass("selected")){a=a.data("page");var b=e.currentFolder();b.handler.isChangingPage=!0;b.handler.currentPage(a)}},"{window} click":function(a,
b){var f=c(b.target).attr("class");/pageSelection|paginationPage/.test(f)||d.pageSelection().hasClass("expanded")&&d.pageSelection().removeClass("expanded")},_search:function(a){d.itemBeforeSearch||(d.itemBeforeSearch=d.currentItem().meta());d.element.addClass("searching");d.itemField().addClass("searching");d.searchItemGroup||(d.searchItemGroup=d.view.itemGroup().appendTo(d.itemField()));d.searchItemGroup.addClass("active search-mode");var c;d.searchView=b.search(a).create({from:0,to:300}).updated(function(a){var b=
a.length;if(1>b)c=setTimeout(function(){e.currentFolderStatus("emptySearch")},500);else{clearTimeout(c);e.currentFolderStatus("ready");for(i=0;i<b;i++)e.createFile(a[i]).element.appendTo(d.searchItemGroup);d.setItemLayout()}})},clearSearch:function(a){d.folderRefreshSeed=c.uid();a&&d.searchInput().val("").blur();d.element.removeClass("searching");d.itemField().removeClass("searching");d.searchItems&&c.each(d.searchItems,function(a,b){c(b).detach()});d.searchItemGroup&&(d.searchItemGroup.find(".browserItem").detach(),
d.searchItemGroup.removeClass("active"));d.searchView&&d.searchView.destroy();delete d.searchView;d.itemBeforeSearch&&d.locateItem(d.itemBeforeSearch)},"{searchInput} focusin":function(a){a.parent().addClass("active");""!==c.trim(a.val())&&a.parent().addClass("showCancelButton")},"{searchInput} focusout":function(a){setTimeout(function(){""===c.trim(a.val())&&a.parent().removeClass("active showCancelButton")},50)},"{searchInput} keyup":function(a){var b=c.trim(a.val());""===b?(a.parent().removeClass("showCancelButton"),
d.clearSearch(),delete d.itemBeforeSearch):(a.parent().addClass("showCancelButton"),d.search(b))}}});EasyBlog.Controller("Media.Browser.Actions",{defaultOptions:{"{customizeItemButton}":".customizeItemButton","{insertAsGalleryButton}":".insertAsGalleryButton","{insertItemButton}":".insertItemButton","{insertBlogImageButton}":".insertBlogImageButton","{createFolderButton}":".createFolderButton","{confirmCreateFolderButton}":".createFolderPrompt .confirmCreateFolderButton","{folderPath}":".createFolderPrompt .folderPath",
...
"{retryPopulateButton}":".retryPopulateButton"}},function(d){return{init:function(){},"{self} itemActivate":function(a,b,c){d.item=c;a=c.place().acl;d.removeItemButton().toggle(a.canRemoveItem);d.createFolderButton().toggle(a.canCreateFolder);d.insertBlogImageButton().toggle("blogimage"===e.mode()&&"image"===c.meta().type)},"{customizeItemButton} click":function(){a.edit(d.item.key)},"{insertAsGalleryButton} click":function(){a.insert(d.item.key)},"{insertItemButton} click":function(){a.insert(d.item.key)},
"{insertBlogImageButton} click":function(){EasyBlog.dashboard.blogImage.setImage(b.meta[d.item.key]);a.hide()},"{createFolderButton} click":function(){f.get("createFolderPrompt").show().state("default");var a=e.currentFolder();d.folderPath().html(a.meta().friendlyPath);d.folderInput().focus()[0].select()},"{folderInput} keyup":function(a,b){13==b.keyCode&&d.confirmCreateFolderButton().click()},"{confirmCreateFolderButton} click":function(){var a=c.trim(d.folderInput().val());if(""!==a){var h=e.currentFolder().meta(),
n=h.friendlyPath+g+a;d.folderCreationPath().html(n);var k=f.get("createFolderPrompt");k.state("progress");b.createFolder(h,a).done(function(a){a=e.createFolder(a);k.hide();e.activateItem(a)}).fail(function(a){d.folderCreationFailedReason().html(a);k.state("fail")})}},"{removeItemButton} click":function(){d.removeItemFilename().html(d.item.meta().title);f.get("removeItemPrompt").show().state("default")},"{confirmRemoveItemButton} click":function(a){var c=f.get("removeItemPrompt");c.state("progress");
b.removeRemoteMeta(d.item.key).done(function(){c.hide()}).fail(function(a){d.removeItemFailedReason().html(a);c.state("fail")})},"{flickrLoginButton} click":function(a){var c=a.data("login");a=a.data("callback");var d=e.enqueue(function(){e.activatePlace("flickr").done(e.enqueue(function(a,b){e.activateItem(b)}))});window[a]=function(){b.getPlace("flickr").options.associated=!0;d()};window.open(c,"Flickr Login","scrollbars=no, resizable=no, width=650, height=700")},"{cancelSearchButton} click":function(){e.clearSearch(!0)},
"{retryPopulateButton} click":function(){var a=d.item.place();delete a.activator;a.populated=!1;a.treeItem.click()}}});h.resolve()})});EasyBlog.module("media/browser.item",function(c){EasyBlog.Controller("Media.Browser.Item",{defaultOptions:{"{itemTitle}":".itemTitle","{itemIcon}":".itemIcon","{childItem}":".browserItem",hasCustomHandler:["folder"]}},function(h){var a,b,e;return{init:function(){a=h.media;b=a.library;e=a.browser;h.element.data("item",h).addClass("item-type-"+h.meta().type);h.meta().data.on("removed",
function(){e.removeItem(h)});h.createHandler()},meta:function(){return b.getMeta(h.key)},place:function(){return b.getPlace(h.key)},parentFolder:function(){return e.getItem(b.getParentKey(h.key))},createHandler:function(){if(!(0>c.inArray(h.meta().type,h.options.hasCustomHandler))){var a=EasyBlog.Controller.Media.Browser.Item[c.String.capitalize(h.meta().type)];void 0===a?EasyBlog.require().script("media/browser.item."+h.meta().type).done(function(){h.createHandler()}):h.handler=new a(h.element,{controller:{media:h.media,
item:h}})}},activate:function(){h.setLayout();h.handler&&h.handler.activate()},remove:function(){try{h.handler&&(h.handler._destroyed||h.handler.destroy()),h.element&&h.element.remove()}catch(a){}},isVisible:function(){var a=h.element,b=a.outerHeight(),a=a.offset().top,c=a+b,e=h.media.browser.itemField(),m=e.offset().top,e=m+e.height();isVisible=!(a<m&&c<m||a>e&&c>e);h.media.options.debug.itemVisiblity&&h.media.console("info",["Item visibility",{title:h.meta().title,isVisible:isVisible,item:h,itemHeight:b,
itemTop:a,itemBottom:c,itemFieldTop:m,itemFieldBottom:e}]);return isVisible},setLayout:function(a){if("folder"!=h.meta().type){if(h.handler&&c.isFunction(h.handler.setLayout))return h.handler.setLayout();h.setIcon()}},setIcon:function(){h.setIcon.loading||h.setIcon.loaded||void 0===h.meta().icon||h._destroyed||(h.setIcon.loading=!0,e.iconThread.addDeferred(function(a){var b=h.itemIcon();if(h.isVisible()){var c=h.meta(),e=h.place(),m=c.icon.url;h.setIcon.useNaturalUrl||/easysocial|jomsocial|flickr/.test(e.id)||
"image"!==c.type||(m=EasyBlog.baseUrl+"&view=media&layout=getIconImage&place="+encodeURIComponent(e.id)+"&path="+encodeURIComponent(h.meta().path)+"&format=image&tmpl=component");h.element.addClass("loading-icon");b.image("get",m).done(function(){h.element.removeClass("loading-icon");h.setIcon.loaded=!0;h.setIcon.loading=!1;a.resolve()}).fail(function(){h.element.removeClass("loading-icon");h.setIcon.loaded=!1;h.setIcon.loading=!1;a.reject();h.setIcon.triedNaturalUrl||(h.setIcon.useNaturalUrl=!0,
h.setIcon.triedNaturalUrl=!0)})}else h.setIcon.loading=!1,a.reject()}))}}});EasyBlog.Controller("Media.Browser.Item.Folder",{defaultOptions:{"{childItem}":".browserItem"}},function(h){var a,b,e;return{init:function(){a=h.media;b=a.library;e=a.browser;h.element.empty()},items:{},setLayout:function(){var b=h.item.place(),c;switch(b.ready.state()){case "pending":c="loading";break;case "rejected":c="error";break;case "resolved":if(h.folderView&&0<h.folderView.map.length)c="ready",e.browserPagination().show();
